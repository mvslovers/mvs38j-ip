...
// jmm - physadr, label_t conflict
// jmm - changed bit fields to unsigned int for Systems/C 
//	 -fansi_bitfield option
...
union pg_reg {
	...
	struct pg_field{
		...
		unsigned	pg_space:2;		/* address space jmm */
							// also removed 'enum' jmm
