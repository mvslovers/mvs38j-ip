...
#define	NIF_LOOPDEV	-1		// inithost, initgate: loopback
					// device adapter device number
...
struct	netif {				/* info about one net interface	*/
	...
	IPaddr		ni_brc;		/* IP subnet broadcast address	*/
...
extern	char	loopback_text[];
#endif

#define	NODUMP_NIF	0		// nifdump
#define	DUMP_NIF	1		// nifdump

int	nifdump(char *, struct netif *, int);
