...
int		nb_clearl(struct ospf_nb *);
int		nb_makel(struct ospf_nb *);
int		nb_mismatch(struct ospf_if *, struct ospf_nb *);
int		nb_rexmt(struct ospf_if *, struct ospf_nb *);

void		ospf_hin(struct ep *), ospf_ddin(struct ep *);
int		ospf_in(struct netif *, struct ep *);
